...
class TrucoGame {
    ...
    _redefineCardsPower(trumpCards) {
    ...
    handleTrumpCard() {
        ...
        if (flippedCard) {
            ...
            const trumpCards = this.deck.filter(card => card.order == this.handleCardsOrder(flippedCard.order));
